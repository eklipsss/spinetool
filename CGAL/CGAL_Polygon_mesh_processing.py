...
def approximate_Hausdorff_distance(*args):
    return _CGAL_Polygon_mesh_processing.approximate_Hausdorff_distance(*args)

def approximate_symmetric_Hausdorff_distance(*args):
    return _CGAL_Polygon_mesh_processing.approximate_symmetric_Hausdorff_distance(*args)
...
def duplicate_non_manifold_vertices(P):
    return _CGAL_Polygon_mesh_processing.duplicate_non_manifold_vertices(P)
