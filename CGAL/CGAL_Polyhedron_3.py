...
class Integer_triple(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    first = property(_CGAL_Polyhedron_3.Integer_triple_first_get, _CGAL_Polyhedron_3.Integer_triple_first_set)
    second = property(_CGAL_Polyhedron_3.Integer_triple_second_get, _CGAL_Polyhedron_3.Integer_triple_second_set)
    third = property(_CGAL_Polyhedron_3.Integer_triple_third_get, _CGAL_Polyhedron_3.Integer_triple_third_set)

    def __init__(self, *args):
        _CGAL_Polyhedron_3.Integer_triple_swiginit(self, _CGAL_Polyhedron_3.new_Integer_triple(*args))

    def deepcopy(self, *args):
        return _CGAL_Polyhedron_3.Integer_triple_deepcopy(self, *args)
    __swig_destroy__ = _CGAL_Polyhedron_3.delete_Integer_triple

# Register Integer_triple in _CGAL_Polyhedron_3:
_CGAL_Polyhedron_3.Integer_triple_swigregister(Integer_triple)
class Polyhedron_3_Modifier_3(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def get_modifier(self):
        return _CGAL_Polyhedron_3.Polyhedron_3_Modifier_3_get_modifier(self)

    def set_modifier_data(self, pt_range, int_range):
        return _CGAL_Polyhedron_3.Polyhedron_3_Modifier_3_set_modifier_data(self, pt_range, int_range)

    def __init__(self):
        _CGAL_Polyhedron_3.Polyhedron_3_Modifier_3_swiginit(self, _CGAL_Polyhedron_3.new_Polyhedron_3_Modifier_3())
    __swig_destroy__ = _CGAL_Polyhedron_3.delete_Polyhedron_3_Modifier_3

# Register Polyhedron_3_Modifier_3 in _CGAL_Polyhedron_3:
_CGAL_Polyhedron_3.Polyhedron_3_Modifier_3_swigregister(Polyhedron_3_Modifier_3)
