...
try:
    from src.spine_analysis.shape_metric.utils import register_attachment_center, register_dendrite_skeleton
except Exception:
...
def _attachment_point_from_spine_mesh(mesh: Any) -> np.ndarray:
    ...
    try:
        from src.spine_analysis.shape_metric.junction_metric import select_trimesh_junction_boundary_loop
